    ...
    ClippingRectangle {
        ...
        ColumnLayout {
            ...
            Text {
                ...
                transform: Translate { id: titleT; y: 0 }
                onTextChanged: titleFade.restart()
            }

            ParallelAnimation {
                id: titleFade
                NumberAnimation { target: title; property: "opacity"; from: 0; to: 1; duration: 280; easing.type: Easing.OutCubic }
                NumberAnimation { target: titleT; property: "y"; from: 6; to: 0; duration: 320; easing.type: Easing.OutCubic }
            }
            ...
            RowLayout{
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        scale: prevMouse.pressed ? 0.8 : (prevMouse.containsMouse ? 1.25 : 1.0)
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        scale: playMouse.pressed ? 0.8 : (playMouse.containsMouse ? 1.25 : 1.0)
                        Behavior on scale { NumberAnimation { duration: 150; easing.type: Easing.OutBack } }
                        Behavior on color { ColorAnimation { duration: 150 } }
                    }
                    MouseArea {
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        font.family: Theme.fontfamily
                        font.pixelSize: Theme.fontxxl
                        scale: nextMouse.pressed ? 0.8 : (nextMouse.containsMouse ? 1.25 : 1.0)
                        Behavior on scale { NumberAnimation { duration: 150; easing.type: Easing.OutBack } }
                        Behavior on color { ColorAnimation { duration: 150 } }
                    }
                    MouseArea {
